...
mod tests {
    ...
    use super::{
        ...
        RefusalKind, Whitespace, WhitespaceMode, distinct_hunk_selection_count,
        distinct_line_selection_counts, editor_exit_code, git_error_details, git_exit_code,
        parse_line_selection_document, parse_selection_document, project_exit_code, project_value,
        requested_json, single_line,
    };
